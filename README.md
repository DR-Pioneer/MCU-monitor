...
## OVERVIEW
![image]([https://github.com/DR-Pioneer/MCU-monitor/blob/main/assert/main.png](https://github.com/DR-Pioneer/MCU-monitor/blob/main/assert/use.gif))
## Guide
...
- The curve window can observe up to 10 variables simultaneously.
- The RTT window supports fast sampling of variables, but only supports one channel.
## Requisites
